    ...
    <>
      ...
      <JsonLd
        data={getWebPageSchema({
          name: "Terms of Service - MapleCatch",
          url: `${baseUrl}/terms`,
          description:
            "MapleCatch Terms of Service - Read our terms and conditions for using our smart shopping app for Canadian businesses.",
          breadcrumb: [
        ...
        <div className="relative space-y-6">
          <div className="bg-white rounded-xl p-5 border border-light-border-primary shadow-sm">
            ...
            <p className="text-sm sm:text-base text-light-text-secondary leading-relaxed">
              MapleCatch offers both guest access and account-based access.
              Users can explore selected features without creating an account.
              To access full features like shopping list creation, local brand
              suggestions, and profile customization, users must sign in using
              Apple, Google, or email/password. Verified email is required for
          ...
          <div className="bg-white rounded-xl p-5 border border-light-border-primary shadow-sm">
            ...
            <p className="text-sm sm:text-base text-light-text-secondary leading-relaxed">
              Custom products are user-generated and visible only to the
              creator. While we do not moderate this content, we may remove
              inappropriate or flagged entries at our discretion.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-5 border border-light-border-primary shadow-sm">
            ...
            <p className="text-sm sm:text-base text-light-text-secondary leading-relaxed">
              ...
              anonymized, aggregated data to enhance app functionality and
          ...
          <div className="bg-white rounded-xl p-5 border border-light-border-primary shadow-sm">
            ...
            <p className="text-sm sm:text-base text-light-text-secondary leading-relaxed">
              Lottery participation details and eligibility will be shared in
              future updates. Participation may be subject to regional laws and
              age restrictions.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-5 border border-light-border-primary shadow-sm">
            ...
            <p className="text-sm sm:text-base text-light-text-secondary leading-relaxed">
              ...
              content, and explore upcoming features. Account creation is
              required for interactive and personalized features such as list
          ...
          <div className="bg-white rounded-xl p-5 border border-light-border-primary shadow-sm">
            ...
            <p className="text-sm sm:text-base text-light-text-secondary leading-relaxed">
              Features may be added, removed, or modified without prior notice.
              We are not responsible for data loss or access interruptions due
              to maintenance, system errors, or third-party service outages.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-5 border border-light-border-primary shadow-sm">
            ...
            <p className="text-sm sm:text-base text-light-text-secondary leading-relaxed">
              We are not liable for inaccurate product or brand data, missed
              lottery outcomes, or actions taken based on user-generated
              content. MapleCatch also disclaims responsibility for third-party
              services or platform outages.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-5 border border-light-border-primary shadow-sm">
            ...
            <p className="text-sm sm:text-base text-light-text-secondary leading-relaxed">
              Users may optionally support MapleCatch development through
              platforms like Ko‑fi. These contributions are voluntary and do not
              unlock exclusive features. Payment processing is handled
              externally and securely by Ko‑fi.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-5 border border-light-border-primary shadow-sm">
            ...
            <p className="text-sm sm:text-base text-light-text-secondary leading-relaxed">
              ...
              changes within the app or via your registered email. Continued use
              of the app implies acceptance of revised terms.
            </p>
          </div>
