...
const TermsOfService = () => (
  <section className="relative bg-gradient-to-br from-white via-light-surface-primary to-white rounded-2xl shadow-lg p-6 sm:p-8 mb-6 sm:mb-8 mt-16 border border-[#C62828]">
    ...
    <div className="relative flex items-center gap-3 mb-6">
      ...
      <div>
        <h2 className="text-2xl sm:text-3xl font-inter-bold text-light">
          Terms of Service
        </h2>
