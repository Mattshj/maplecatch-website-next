...
const features = [
  {
    icon: <FaListAlt className="text-2xl text-primary" />, // Smart Shopping Lists
    title: "Smart Shopping Lists",
    desc: "Create and manage personalized grocery lists. Add items, mark them as purchased, and stay organized.",
  },
  {
    icon: <FaListAlt className="text-2xl text-primary" />, // Discover Canadian Brands
  ...
  {
    icon: <FaSearch className="text-2xl text-primary" />, // Brand Explorer
  ...
  {
    icon: <FaUserAlt className="text-2xl text-primary" />, // Personalize
    title: "Personalize Your Experience",
    desc: "Choose between light and dark themes. Update your profile with your name, birthdate, phone number, and location.",
  },
  {
    icon: <FaSignInAlt className="text-2xl text-primary" />, // Flexible Sign-In
  ...
  {
    icon: <FaShieldAlt className="text-2xl text-primary" />, // Privacy & Support
