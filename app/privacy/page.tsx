    ...
    <>
      ...
      <JsonLd
        data={getWebPageSchema({
          name: "Privacy Policy - MapleCatch",
          url: `${baseUrl}/privacy`,
          description:
            "MapleCatch Privacy Policy - Learn how we collect, use, and protect your personal information. We're committed to privacy and transparency.",
          breadcrumb: [
        ...
        <div className="relative space-y-6">
          <div className="bg-white rounded-xl p-5 border border-light-border-primary shadow-sm">
            ...
            <p className="text-sm sm:text-base text-light-text-secondary mb-3 leading-relaxed">
              Depending on how you use MapleCatch (as a guest or signed-in
              user), we may collect:
            </p>
          ...
          <div className="bg-white rounded-xl p-5 border border-light-border-primary shadow-sm">
            ...
            <p className="text-sm sm:text-base text-light-text-secondary leading-relaxed">
              Guests can use select features without creating an account. In
              this mode, no personal information (like name or email) is
              collected or linked to your identity. Preferences (e.g., theme
              mode) may be stored locally on your device.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-5 border border-light-border-primary shadow-sm">
            ...
            <p className="text-sm sm:text-base text-light-text-secondary leading-relaxed">
              All user accounts are secured via Firebase Authentication. Data
              such as shopping lists or preferences is stored on our servers.
              Cached product data may temporarily reside on your device (for up
              to 7 days) to improve performance.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-5 border border-light-border-primary shadow-sm">
            ...
            <p className="text-sm sm:text-base text-light-text-secondary leading-relaxed">
              ...
              third parties. Only Google, Apple, and Firebase services are used
              for authentication and data infrastructure.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-5 border border-light-border-primary shadow-sm">
            ...
            <p className="text-sm sm:text-base text-light-text-secondary leading-relaxed">
              ...
              custom products and lists — is permanently removed. Deletion
              requests require email verification to protect your account.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-5 border border-light-border-primary shadow-sm">
            ...
            <p className="text-sm sm:text-base text-light-text-secondary leading-relaxed">
              If you choose to support us through third-party platforms like
              Ko‑fi, your payment information is never handled by MapleCatch.
              All donations are optional and processed externally.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-5 border border-light-border-primary shadow-sm">
            ...
            <p className="text-sm sm:text-base text-light-text-secondary leading-relaxed">
              Sign in with Apple is available and complies with privacy
              requirements by allowing you to hide your email and limiting
              shared information to name and email. No additional tracking or
              advertising is performed based on this data.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-5 border border-light-border-primary shadow-sm">
            ...
            <p className="text-sm sm:text-base text-light-text-secondary leading-relaxed">
              We send only account-related emails (such as verification or
              password reset) from <strong>noreply@maplecatch.com</strong>. We
          ...
          <div className="bg-white rounded-xl p-5 border border-light-border-primary shadow-sm">
            ...
            <p className="text-sm sm:text-base text-light-text-secondary mb-3 leading-relaxed">
              MapleCatch displays publicly available Canadian brand information
              to help users discover local businesses. Content is sourced from
              public data, user contributions, or AI-generated summaries.
            </p>
            <p className="text-sm sm:text-base text-light-text-secondary leading-relaxed">
              We do not claim ownership of any third-party brand names.
              Inclusion of brand content does not imply endorsement or
              affiliation unless explicitly noted. Users may report any
              inaccuracies through the app.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-5 border border-light-border-primary shadow-sm">
            ...
            <p className="text-sm sm:text-base text-light-text-secondary leading-relaxed">
              ...
              reach out to us at support@maplecatch.com.
            </p>
          </div>
        </div>
      </section>
